    ...
    public class OutlineImage : CustomImageBase
    {
        ...
        protected override void UpdateMaterial(Material baseMaterial)
        {
            ...
            if (canvasScaler != null)
            {
                ...
                {
                    // sprite atlasãŒä½¿ã‚ã‚Œã¦ã„ã‚‹å ´åˆ
                ...
                // texture sizeã«ã‚ˆã£ã¦ç·šã®å¤ªã•ã«å·®ãŒå‡ºãªã„ã‚ˆã†ã€canvasã«å¯¾ã—ã¦ã®æ¯”ç‡ã‚’shaderã§æ›ã‘åˆã‚ã›ã‚‹
        ...
        public void Capture()
        {
            ...
            // TryGetComponent‚Íˆø”‚Éw’è‚µ‚½ƒRƒ“ƒ|[ƒlƒ“ƒg‚ªAdd‚³‚ê‚Ä‚¢‚é‚©‚ğŠm”F‚Å‚«‚é
